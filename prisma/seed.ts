  ...
  const properties = [
    {
      ...
      monthlyManagementFee: 240,
      otherMonthlyExpenses: 85,
      value: 485000,
      tax: 9200,
      assessed: 410000,
    ...
    },
    {
      ...
      monthlyManagementFee: 1850,
      otherMonthlyExpenses: 650,
      value: 2450000,
      tax: 38500,
      assessed: 2100000,
      managerId: manager.id,
  ...
  for (const item of properties) {
    const property = await prisma.property.create({
      data: {
        ...
        monthlyManagementFee: item.monthlyManagementFee,
        otherMonthlyExpenses: item.otherMonthlyExpenses,
        isSampleData: true,
